...
flsModules.tippy = tippy('[data-tippy-content-testers]', {
	...
	placement: 'right',
	allowHTML: true,
	content: '<div class="tippy__wrapper"><div class="tippy__top"><div class="tippy__title">title</div><div class="tippy__close"></div><div class="tippy__content">Тестер - это демонстрационный образец, отличительной особенностью которого является упрощенная упаковка или ее отсутствие. С точки зрения содержимого флакона отличий от товара в обычной упаковке нет. С пометкой «тестер» также может продаваться товар, упаковка которого не соответствует подарочному виду (например, подмятый уголок коробки, надорванный или потертый целлофан). Флакон тестера иногда может не иметь дизайнерской крышки.</div></div></div>'
});